...
C_RETURN_ERROR_CODE = {
    -1: "[SIGHUP] Report that user's terminal is disconnected. Signal used to report the termination of the controlling process.",
    -2: "[SIGINT]Program interrupt. (ctrl-c)",
    -3: "[SIGQUIT] Terminate process and generate core dump.",
    -4: "[SIGILL] llegal Instruction (ANSI)",
    -5: "[SIGTRAP] Trace trap (POSIX)",
    -6: "[SIGABRT ] Abort (ANSI)",
    -7: "[SIGBUS] Indicates an access to an invalid address.",
    -8: "[SIGFPE ] This includes division by zero and overflow.",
    -9: "[SIGKILL] Cause immediate program termination.",
    -10: "[SIGUSR1] User-defined signal 1",
    -11: "[SIGSEGV] Occurs when a program tries to read or write outside the memory that is allocated for it by the operating system, dereferencing a bad or NULL pointer.",
    -12: "[SIGUSR2] User-defined signal 2",
    -13: "[SIGPIPE] Error condition like trying to write to a socket which is not connected.",
    -14: "[SIGALRM] Indicates expiration of a timer. Used by the alarm() function.",
    -15: "[SIGTERM] This signal can be blocked, handled, and ignored. Generated by \"kill\" command."
}
...
class RunCmd(threading.Thread):
    ...
    def run(self): # this is intertal.
        ...
        self.p.stdin.write(self.inp.encode('ascii'))
        self.p.stdin.flush()
        self.p.wait()
            ...
            if LangConfig.get(self.lang).get('compile_is_run') is True:
                ...
                if res['can_run'] ==  'yes' and self.testcases:
                    ...
                    if ret['is_timeout']:
                        ...
                        ret['output'] = C_RETURN_ERROR_CODE.get(ret['return_code'], "Program crashed due to "+str(ret['return_code']))+ret['stdout']
                    return ret
                else:
                    return res
        except Exception as e:
